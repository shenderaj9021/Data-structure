...
def rule5(symptoms):
    if 'shortness of breath' in symptoms and 'chet pain' in symptoms and 'dizziness' in symptoms:
...
def diagnose(symptoms):
    ...
    if len(results)==0:
        return 'Sorrry, we could not diagnose you condition.'
    elif len(results)==1:
        return results[0]
    else:
